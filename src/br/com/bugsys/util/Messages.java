...
public interface Messages {
	...
	String MSG_WORKFLOW_BOUND_PROJECT = 	"O workflow não pode ser excluído pois o mesmo está vinculado a um ou mais projetos.";
	String MSG_EXISTS_PROJECT_NAME =		"J&aacute; existe um registro cadastrado com o Nome do Projeto informado.";
	String MSG_USER_PROJECT_VINCULED = 		"O usuário não pode ser excluído, pois o mesmo está vinculado a um ou mais projetos.";
	String MSG_CLIENT_PROJECT_VINCULED =	"O cliente não pode ser excluído, pois o mesmo está vinculado a um ou mais projetos.";
	String MSG_PROJECT_EVENT_VINCULED =		"O projeto não pode ser excluído, pois o mesmo está vinculado a uma ou mais ocorrências.";
}
